...
CKPT = "/mnt/data/sinogram_generator/sanity_viz_dose_improved/latest.pt"
...
m = DosePrediction2p5D(base_filters=24, in_channel=2, n_leaves=64, reduce_h=False).to(dev)
...
np.save("/mnt/data/sinogram_generator/ccc_pred_183040.npy", dose.dose)
print("saved ccc_pred_183040.npy", flush=True)
