...
def plot_live_inference_result(
    ...
    if display_mode == "Compact overview":
        ...
        _imshow_with_colorbar_live(fig, axes[0, 0], baseline, "Frozen baseline", sino_cmap, 0, 1, "auto", interpolation=sinogram_interpolation)
        _imshow_with_colorbar_live(fig, axes[0, 1], pred, "Prediction / refined", sino_cmap, 0, 1, "auto", interpolation=sinogram_interpolation)
        _imshow_with_colorbar_live(fig, axes[0, 2], gt, "GT", sino_cmap, 0, 1, "auto", interpolation=sinogram_interpolation)
    ...
    _imshow_with_colorbar_live(fig, axes[0], baseline, "Baseline", sino_cmap, 0, 1, aspect_value, "Leaf", "Control point", sinogram_interpolation)
    _imshow_with_colorbar_live(fig, axes[1], pred, "Prediction", sino_cmap, 0, 1, aspect_value, "Leaf", "", sinogram_interpolation)
    _imshow_with_colorbar_live(fig, axes[2], gt, "Ground truth", sino_cmap, 0, 1, aspect_value, "Leaf", "", sinogram_interpolation)
...
def tab_live_inference() -> None:
    ...
    with s4:
        panel_width = st.slider(
            ...
            value=1.65,
            step=0.05,
            help="Lower value makes each sinogram panel thinner.",
