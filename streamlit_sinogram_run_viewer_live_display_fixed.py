...
def plot_live_inference_result(
    ...
    _imshow_with_colorbar_live(fig, axes[0], baseline, "Baseline", sino_cmap, 0, 1, aspect_value, "Leaf", "Control point")
    _imshow_with_colorbar_live(fig, axes[1], pred, "Prediction", sino_cmap, 0, 1, aspect_value, "Leaf", "")
    _imshow_with_colorbar_live(fig, axes[2], gt, "Ground truth", sino_cmap, 0, 1, aspect_value, "Leaf", "")
    _imshow_with_colorbar_live(fig, axes[3], abs_pred_diff, "|Pred - GT|", absdiff_cmap, 0, 0.5, aspect_value, "Leaf", "")
    _imshow_with_colorbar_live(fig, axes[4], signed_pred_diff, "Pred - GT", signed_cmap, -0.3, 0.3, aspect_value, "Leaf", "")
    ...
    if delta is not None:
        ...
        vmax = min(vmax, 0.15)
        _imshow_with_colorbar_live(fig, axes[5], delta, "Predicted delta", signed_cmap, -vmax, vmax, aspect_value, "Leaf", "")
